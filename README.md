...
- [ ] **Увеличить объëм обучающих данных:** 

Расширить датасет примерами людей без шлемов и дообучить модель на сложных примерах (капюшоны, шапки), чтобы снизить ложные срабатывания.
